...
public:
   HubbleTelescope();
   HubbleTelescope(Position* initialPos,
      Velocity* initialVelocity, Angle* initialAngle):
   Orbital(initialPos, 3, 10.0, initialVelocity, initialAngle){}
   ~HubbleTelescope() { }
...
public:
   HubbleComputer();
   HubbleComputer(Position* initialPos,
      Velocity* initialVelocity, Angle* initialAngle):
   Orbital(initialPos, 2, 7.0, initialVelocity, initialAngle){}
   ~HubbleComputer() { }
...
public:
   HubbleLeft();
   HubbleLeft(Position* initialPos,
      Velocity* initialVelocity, Angle* initialAngle):
   Orbital(initialPos, 2, 8.0, initialVelocity, initialAngle){}
   ~HubbleLeft() { }
...
public:
   HubbleRight();
   HubbleRight(Position* initialPos,
      Velocity* initialVelocity, Angle* initialAngle):
   Orbital(initialPos, 2, 8.0, initialVelocity, initialAngle){}
   ~HubbleRight() { }
